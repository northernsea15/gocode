...
<tr><td><button id="start_build" style="height:50px;width:100px">构建开发环�?</button>&nbsp;&nbsp;&nbsp;<button id="sync_46" style="height:50px;width:100px">同步测试环境</button>&nbsp;&nbsp;&nbsp;<button id="restart_46" style="height:50px;width:100px">重启测试环境</button></td></tr>
...
function onSync46(){
	...
	var url = "http://"+window.location.hostname+"/sync_test.php";
	$.ajax({
  type: "POST",
  url: url,
  data: {},
...
function onRestart46(){
	...
	var url = "http://"+window.location.hostname+"/restart_test.php";
	$.ajax({
  type: "POST",
  url: url,
  data: {},
